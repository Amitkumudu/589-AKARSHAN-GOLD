...
Partial Public Class dsinvoice
    ...
    Partial Public Class rptsessionDataTable
        ...
        Public Overloads Function AddrptsessionRow( _
            ...
            Dim columnValuesArray() As Object = New Object() {key, id, slno, metal, item, beedname, gross, beeds, mc, size, purity, note, ivalue, pcs, b_pcs, b_ct, b_class, rate, rtype, mcpg, customer, d_date, staff, wastage, adv_detail, image, filepath, hc, hsncode}
