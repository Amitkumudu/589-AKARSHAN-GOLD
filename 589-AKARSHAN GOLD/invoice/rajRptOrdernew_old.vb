...
Public Class rajRptOrdernew_old
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "invoice.rajRptOrdernew_old.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrajRptOrdernew_old
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rajRptOrdernew_old = New rajRptOrdernew_old()
        rpt.Site = Me.Site
        Return rpt
    End Function
